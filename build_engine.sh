...
echo g++ $cppFilenames external/glad/src/glad.c $compilerFlags -o bin/$assembly $defines $includeFlags $linkerFlags
g++ $cppFilenames external/glad/src/glad.c $compilerFlags -o bin/$assembly $defines $includeFlags $linkerFlags

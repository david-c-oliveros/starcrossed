...
void UI::RenderLevelEditPanel(glm::ivec2 vWindowSize)
{
    ImGuiWindowFlags windowFlags = ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoNav;

    static bool bShowLevelEditPanel = true;
    ...
    ImGui::Begin("Level Editor", &bShowLevelEditPanel, windowFlags);

    ImGui::Text("Add new room");
